(function () {
	...
	let totalTime =
		Number(getComputedStyle(circleContainer).getPropertyValue('--totalTime')) *
		1000;
	let breathInTime =
		Number(getComputedStyle(circleContainer).getPropertyValue('--breathIn')) *
		1000;
	let holdTime =
		Number(getComputedStyle(circleContainer).getPropertyValue('--hold')) * 1000;
